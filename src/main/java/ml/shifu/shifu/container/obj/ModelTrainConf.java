...
public class ModelTrainConf {
    ...
    public static Map<String, Object> createParamsByAlg(ALGORITHM alg, ModelTrainConf trainConf) {
        ...
        if(ALGORITHM.NN.equals(alg)) {
        ...
        } else if(ALGORITHM.DNN.equals(alg)) {
        	params.put(CommonConstants.LEARNING_RATE, 0.1);
        	params.put(CommonConstants.NUM_HIDDEN_LAYERS, 1);
        	List<Integer> nodes = new ArrayList<Integer>();
            nodes.add(50);
            ...
            layer.add("dense");
            params.put("LayerName", layer);
            List<String> kernel_initializer = new ArrayList<String>();
            kernel_initializer.add("randomnormal");
            params.put("KernelInitializers", kernel_initializer);
            List<String> bias_initializer = new ArrayList<String>();
            params.put("BiasInitializers", bias_initializer);
            bias_initializer.add("constant");
            params.put("Loss", "squared");
            params.put("Optimizer", "sgd");
            params.put("DropoutRate", 0.1);
