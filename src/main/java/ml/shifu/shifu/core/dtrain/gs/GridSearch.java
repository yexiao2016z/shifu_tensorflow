...
public class GridSearch {
    ...
    private void parseParams(Map<String, Object> params) {
        ...
        for(Entry<String, Object> entry: sortedMap.entrySet()) {
            if(entry.getKey().equals("ActivationFunc") || entry.getKey().equals("NumHiddenNodes") || entry.getKey().equalsIgnoreCase("KernelInitializers") 
            		|| entry.getKey().equals("LayerName") || entry.getKey().equals("BiasInitializers")) {
